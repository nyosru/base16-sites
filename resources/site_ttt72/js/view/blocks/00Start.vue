        ...
        <div class="px-6 w-full flex flex-wrap items-center justify-between">
          ...
          <div class="flex items-center lg:ml-auto">
            <a
              ...
              type="button"
              class="inline-block px-6 py-2.5 mr-2 bg-transparent text-blue-600 font-medium text-md leading-tight uppercase rounded hover:text-blue-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none focus:ring-0 active:bg-gray-200 transition duration-150 ease-in-out"
              data-mdb-ripple="true"
              data-mdb-ripple-color="light"
            >
              8-922-263-06-18
        ...
        <div class="container mx-auto xl:px-32">
          <div class="grid lg:grid-cols-2 gap-12 flex items-center">
            ...
            <div class="mb-12 lg:mb-0">
              <img
                xsrc="https://mdbootstrap.com/img/new/standard/city/017.jpg"
                src="/site_ttt72/img/ab.jpg"
